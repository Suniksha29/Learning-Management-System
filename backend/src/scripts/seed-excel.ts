...
const coursesData = [
  {
    ...
    title: 'AI & ML',
    slug: 'ai-ml',
    description: 'Advanced course on Artificial Intelligence and Machine Learning by Dr. Ankit Sharma',
    sections: [
  ...
  },
  {
    ...
    title: 'Java',
    slug: 'java',
    description: 'Intermediate course on Java programming by Mr. Rahul Verma',
    sections: [
  ...
  },
  {
    ...
    title: 'Python',
    slug: 'python',
    description: 'Beginner course on Python programming by Ms. Sneha Kulkarni',
    sections: [
  ...
  },
  {
    ...
    title: 'Data Science',
    slug: 'data-science',
    description: 'Advanced course on Data Science by Dr. Priya Nair',
    sections: [
...
const seedDatabase = async (): Promise<void> => {
  try {
    ...
    const testUsers = [
      { email: 'test@example.com', name: 'Test User', username: 'test_user' },
      { email: 'student@example.com', name: 'Student User', username: 'student_user' },
    ];
    ...
    for (const user of testUsers) {
      try {
        await query(
          ...
          [user.email, testPassword, user.name, user.username]
        );
    ...
    console.log(`   - ${coursesData.reduce((acc, c) => acc + c.sections.length, 0)} sections created`);
    
    const totalVideos = coursesData.reduce((acc, c) => 
      acc + c.sections.reduce((sum, s) => sum + s.videos, 0), 0
    );
    console.log(`   - ${totalVideos} videos created`);
